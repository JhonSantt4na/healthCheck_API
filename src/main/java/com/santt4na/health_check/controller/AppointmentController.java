...
public class AppointmentController implements AppointmentControllerDocs {
	...
	public ResponseEntity<AppointmentResponseDTO> cancelByDoctor(@PathVariable Long id, @Valid @RequestParam String reason) {
	...
	public ResponseEntity<AppointmentResponseDTO> cancelByPatient(@PathVariable Long id, @Valid @RequestParam String reason) {
